...
#define FOREGROUND_STAR_IMAGE_NAME @"action_bar_star_hit"
#define BACKGROUND_STAR_IMAGE_NAME @"action_bar_star"
#define DEFALUT_STAR_NUMBER 5
#define ANIMATION_TIME_INTERVAL 0.2

@interface PNCStarRatingView ()
...
@implementation PNCStarRatingView

- (instancetype)init {
    NSAssert(NO, @"never call this method in this class. Use initWithFrame: instead!");
    return nil;
}
...
- (void)layoutSubviews {
    ...
    __weak PNCStarRatingView *weakSelf = self;
